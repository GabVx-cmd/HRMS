 ...
 * Expects $pageTitle to be set by the including page before this file is included.
 */
?>
<!DOCTYPE html>
<html lang="en">
...
<title><?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) . ' — HRMS' : 'HRMS'; ?></title>
